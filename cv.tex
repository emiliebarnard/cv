...
\homepage{emiliebarnard.com}
\github{emiliebarnard}
\linkedin{emiliebarnard}
%%% Optionals
\position{Program Manager \& Computer Science Educator in Seattle, WA%{\enskip\cdotp\enskip}
}
...
\newpage
\import{\sectiondir}{organizations.tex}
